...
<div class="modal fade " id="signupModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel" style="font-family:'Secular One', sans-serif";>Signup</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="parts/signuphandler.php" method="post" >
  ...
  <button type="submit" class="btn btn-success " style="font-family:'Secular One', sans-serif"; >Signup</button>
</form>
      </div>
